      ...
      <div class="flex items-center space-x-3 sm:space-x-4 mt-3 sm:mt-0">
        <ul class="flex items-center space-x-3 sm:space-x-4">
          ...
          <li class="relative group">
            ...
            <!-- Cart Summary -->
            <div
              class="absolute right-0 mt-3 w-72 bg-white shadow-lg rounded-lg p-4 opacity-0 group-hover:opacity-100 scale-95 group-hover:scale-100 transition-all duration-300 origin-top-right z-50"
            >
